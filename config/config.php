...
$config = array (
	 ...
	 * reverse proxy).
	 */
	'baseurlpath'           => 'app/saml2/v1/sso/saml_sp/' , //'simplesaml/',
	//'certdir'               => 'cert/',
	'certdir'               => '/etc/pki/tls/private/',//'cert/',
	//'loggingdir'            => 'log/',
	//'loggingdir'            => '/opt/lampp/logs/scrybe_logs/',  // for dev
	'loggingdir'            => '/var/log/httpd/scrybe_logs/',      // for stagging
	'datadir'               => 'data/',
	 ...
	 */
	'auth.adminpassword'		=> 'jdkim!1saml2',
	 ...
	 */
	'secretsalt' => 'rpb1v5h4zirdqkpei8tn7sosjdk46u3k', // see docs
	 ...
	 */
	'technicalcontact_name'     => 'Convo Support',
	'technicalcontact_email'    => 'support@convo.com',//'convosp@gmail.com',//'support@convo.com',
    
	// for dev:    
    'smtp.params'              => array('host'=>'58.65.167.101', 'port'=>25), // please specify valid smtp parameter  
    // for prod:
    //'smtp.params'              => array('host'=>'184.73.227.205', 'port'=>25), // please specify valid smtp parameter  
	/*
	 ...
	 */
	'logging.logfile'		=> 'saml_service_provider.log',
...
//	'metadata.sources' => array (
//	     	array('type' => 'pdo', 'dsn' => 'mysql:host=192.168.0.83;port=3306;dbname=scrybe_db_latest',
//	     			'username'=>'webuser', 'password' =>'unknown#098', 'prefix' =>'account_sso_settings_with_idp_'),
//	     ),
    
	'metadata.sources' => array (
	     	array('type' => 'db', 'scrybe_app_global_path' => '/var/www/html/app/ScrybeApplicationGlobals.php',
	     			'table_name' =>'account_sso_settings'),
	     ),
