...
$config = array(
	...
	'convo-sp' => array(
		'saml:SP',
		 ...
		 //'saml:NameIDPolicy' => array('Format' => 'urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress',
		// 							'AllowCreate' => FALSE,) ,
		...
		'certificate' => 'star_convo_com.crt',
	    'privatekey' => 'star_convo_com.key',
	    
	    //'redirect.sign' => TRUE,  // used for signout
	    //'redirect.validate' => TRUE,		// used for signout


		'name' => array(
		    'en' => 'Convo service provider',
		),
		...
		'attributes' => array(
				...
				'urn:oid:1.3.6.1.4.1.5923.1.1.1.6',  //eduPrincipalName ( Person's principal name at home organization)
		...
		//'assertion.encryption' => TRUE, // only accept encrypted assertions
